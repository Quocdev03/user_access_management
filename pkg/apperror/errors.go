...
// AppError đại diện cho lỗi tiêu chuẩn của ứng dụng, hỗ trợ wrap lỗi nội bộ và chứa metadata
...
// Unwrap hỗ trợ thư viện errors chuẩn của Go
func (e *AppError) Unwrap() error {
	return e.RootErr
}

// WithErr gắn thêm lỗi gốc (Root Error) vào để phục vụ logging mà không lộ ra ngoài client
func (e AppError) WithErr(err error) *AppError {
	e.RootErr = err
	return &e
}

// WithDetails gắn thêm metadata (ví dụ: danh sách field lỗi validation)
func (e AppError) WithDetails(details interface{}) *AppError {
	e.Details = details
	return &e
}

// WithMessage ghi đè câu thông báo lỗi mặc định bằng một câu cụ thể hơn
func (e AppError) WithMessage(msg string) *AppError {
	e.Message = msg
	return &e
}

// NewAppError tạo một lỗi mới
